...
if (isset($_POST) & !empty($_POST)) {
    ...
    $position = $modelPreparation->countpreparation($_POST['idNew']);

    $paragraphe = new Paragraphes;
    $paragraphe->setContenu($_POST['preparationText']);
    $paragraphe->setIdRecettes($_POST['idNew']);
    $paragraphe->setOrdre($position + 1);

    $modelPreparation->insert($paragraphe);

    $preparations = $modelPreparation->selectAllRecette($_POST['idNew']);
    $i=0;
